...
\input {tex/rozdzialy/1.wstep}
\input {tex/rozdzialy/2.analizaIOP}
\input {tex/rozdzialy/3.technologie}
\input {tex/rozdzialy/4.vaadin}
\input {tex/rozdzialy/5.architektura}
\input {tex/rozdzialy/6.testy}
\input {tex/rozdzialy/8.dodatkoweProdukty}
\input {tex/rozdzialy/9.wnioski}
\input {tex/rozdzialy/10.podsumowanie}
