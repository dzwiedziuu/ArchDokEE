...
import com.aniedzwiedz.dokarchee.action.ComponentWithAction;
import com.aniedzwiedz.dokarchee.action.PojoHandler;
import com.aniedzwiedz.dokarchee.annotations.ColumnHeader;
import com.aniedzwiedz.dokarchee.table.contextMenu.MyContextMenu;
import com.aniedzwiedz.dokarchee.table.contextMenu.MyContextMenu.MyContextMenuOpenedOnTableFooterEvent;
import com.aniedzwiedz.dokarchee.table.contextMenu.MyContextMenu.MyContextMenuOpenedOnTableHeaderEvent;
import com.aniedzwiedz.dokarchee.table.contextMenu.MyContextMenu.MyContextMenuOpenedOnTableRowEvent;
import com.aniedzwiedz.dokarchee.table.contextMenu.MyContextMenu.MyTableListener;
import com.aniedzwiedz.dokarchee.table.exception.NoIDFieldException;
...
public class CRUDTable<T> extends VerticalLayout
{
	...
	{
		if (action instanceof PojoHandler)
		{
			...
			((PojoHandler<T>) action).setPojoObject(t);
		}
		if (actionTaker != null)
